                    ...
                    <ul class="w3-ul w3-card-4">
                        <li class="w3-bar">
                            <div class="w3-block" onclick="this.parentElement.style.display='none'">
                                <img src="${pageContext.request.contextPath}/avatar5.png" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
                                <span class="w3-large"><b>Mike - Moderator</b></span><br>
                                <span>your-seminar-topic-has-accepted</span><br>
                        ...
                        <li class="w3-bar">
                            <div class="w3-block" onclick="this.parentElement.style.display='none'">
                                ...
                                <span>you-have-recommended-to-new-seminar</span><br>
                                <span class="w3-bar-item w3-left">
                        ...
                        <li class="w3-bar">
                            <div class="w3-block" onclick="this.parentElement.style.display='none'">
                                ...
                                <span>be-prepared-for-tommorow-seminar</span><br>
                                <span class="w3-bar-item w3-left">
                            </div>
                        </li>
                        <li class="w3-bar">
                            <div class="w3-block" onclick="this.parentElement.style.display='none'">
                                ...
                                <span>welcome-to-speaker-casta</span><br>
                                <span class="w3-bar-item w3-left">
                            </div>
                        </li>
                    </ul>
