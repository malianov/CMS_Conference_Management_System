    ...
    <div class="w3-card-4">
        <div class="w3-container w3-center w3-green">
            <h2>
                ...
                <fmt:message key="welcome-to-the-system-CMS_user"/></h2>
        </div>
        ...
        <div class="w3-bar w3-light-blue">
            ...
            <div class="w3-dropdown-hover w3-right">
                ...
                <div class="w3-dropdown-content w3-bar-block w3-card-4">
                    <a href="${pageContext.request.contextPath}/view/language/user_page?language=UA"
                       class="w3-bar-item w3-button"><fmt:message key="ukrainian"/></a>
                    <a href="${pageContext.request.contextPath}/view/language/user_page?language=EN"
            ...
            <%@ include file="user_registered_conferences.jsp" %>
