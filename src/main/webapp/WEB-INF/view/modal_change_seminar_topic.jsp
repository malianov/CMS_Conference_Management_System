<button onclick="document.getElementById('${seminar.getIdSeminar()}topic').style.display='block'"
        class="w3-green w3-border-0 w3-round-xxlarge">

    ${seminar.getSeminarTopic()}

</button>
<div id="${seminar.getIdSeminar()}topic" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
        <header class="w3-container w3-red">
            <span onclick="document.getElementById('${seminar.getIdSeminar()}topic').style.display='none'"
