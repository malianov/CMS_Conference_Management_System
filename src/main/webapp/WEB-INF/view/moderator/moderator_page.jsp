    ...
    <div class="w3-card-4">
        <div class="w3-container w3-center w3-green">
            <h2>
                ...
                <fmt:message key="welcome-to-the-system-CMS_moderator"/></h2>
        </div>
        ...
        <div class="w3-bar w3-light-blue">
            ...
            <button class="w3-bar-item w3-button tablink" onclick="openMenu(event,'all-cms-users')"><fmt:message key="all-cms-users"/></button>
