<button onclick="document.getElementById('${all_conferences_list.getIdConference()}place').style.display='block'"
    ...
    <c:if test="${language == 'en' || language == 'en-EN'}">${all_conferences_list.getConferencePlaceEng()}</c:if>
...
<div id="${all_conferences_list.getIdConference()}place" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
        <header class="w3-container w3-red">
            ...
            <h2><fmt:message key="change-conference-place"/></h2>
        </header>
        ...
        <div class="w3-container w3-left-align">
            ...
            <p>
                <fmt:message key="you-are-going-to-chang-the-current-conference-place"/>
            ...
            <form action="${pageContext.request.contextPath}/view/change_conference_place">
                <label class="w3-text-grey"><b><fmt:message key="place-in-english"/></b></label>
                <input class="w3-input w3-border w3-margin-bottom" type="text" name="place_eng">
                <label class="w3-text-grey"><b><fmt:message key="place-in-ukraine"/></b></label>
