...
<div class="w3-container w3-padding w3-margin w3-display-container">
    <div class="w3-card-4">
        ...
        <div class="w3-bar w3-light-blue">
            ...
            <a href="${pageContext.request.contextPath}/view/admin_all_users_page" class="w3-bar-item w3-button w3-hover-red w3-green"><fmt:message key="all-cms-users"/></a>
            ...
            <a href="${pageContext.request.contextPath}/view/admin_archive" class="w3-bar-item w3-button w3-hover-red"><fmt:message key="conference-archive"/></a>
            ...
            <div class="w3-dropdown-hover w3-right">
                ...
                <div class="w3-dropdown-content w3-bar-block w3-card-4">
                    <a href="${pageContext.request.contextPath}/view/language/admin_all_users_page?language=UA"
                       class="w3-bar-item w3-button"><fmt:message key="ukrainian"/></a>
                    <a href="${pageContext.request.contextPath}/view/language/admin_all_users_page?language=EN"
        ...
        <%@ include file="all_cms_users.jsp" %>
