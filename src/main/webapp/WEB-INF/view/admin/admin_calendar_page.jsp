...
<div class="w3-container w3-padding w3-margin w3-display-container">
    <div class="w3-card-4">
        ...
        <div class="w3-bar w3-light-blue">
            ...
            <a href="${pageContext.request.contextPath}/view/admin_calendar_page" class="w3-bar-item w3-button w3-hover-red w3-green"><fmt:message key="conference-calendar"/></a>
            <a href="${pageContext.request.contextPath}/view/admin_archive_page" class="w3-bar-item w3-button w3-hover-red"><fmt:message key="conference-archive"/></a>
        ...
        <%@ include file="calendar_page.jsp" %>
